...
<p><?php echo link_to_if($edit_valid, 'manage/logs/edit/'. $id, str_replace(array('[',']'),'', $label['edit']), array('class' => 'btn btn-primary btn-small'));?></p>
...
<p><?php echo anchor('feed/logs', img($images['feed']).' View Feed', array('class' => 'image'));?></p>
