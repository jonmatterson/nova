...
<?php echo form_open('wiki/page/'. $id .'/edit', 'class="form-horizontal"');?>
	...
	<div class="control-group">
		<label class="control-label"><?php echo text_output($label['changes']);?></label>
		<div class="controls">
			<?php 
			$inputs['changes']['class'] = 'span10';
			echo form_textarea($inputs['changes']);
			?>
		</div>
	</div>
	<?php ?>
	...
	<div class="form-actions">
		<?php 
		$buttons['update']['class'] = 'btn btn-success btn-submit';
		echo form_button($buttons['update']);
		?>
	</div>
