...
<p>
	<?php echo link_to_if(in_array(TRUE, $valid), 'manage/posts/edit/'. $post_id, str_replace(array('[',']'),'', $label['edit']), array('class' => 'btn btn-primary btn-small'));?>
</p>
...
<p><?php echo anchor('feed/posts', img($images['feed']).' View Feed', array('class' => 'image'));?></p>
